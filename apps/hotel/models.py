...
class Extra_person_rate(models.Model):
    ...
    rate = models.DecimalField(null=True, max_digits=12, decimal_places=2, default=0)
...
class Room(models.Model):
    ...
    title = models.CharField(null=True, max_length=256)
    hotel = models.ForeignKey(Hotel, null=True, on_delete=models.CASCADE)
    price = models.DecimalField(null=True, max_digits=12, decimal_places=2, default=0)
...
class Discount(models.Model):
    ...
    reduction = models.DecimalField(null=True, max_digits=12, decimal_places=2, default=0)
