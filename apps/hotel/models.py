...
class Hotel(models.Model):
    ...
    address = models.CharField(null=True, max_length=255, verbose_name=_("آدرس"))
    ...
    default_cover = models.ForeignKey('Cover', on_delete=models.CASCADE, blank=True, null=True,
    ...
    type = models.SmallIntegerField(choices=TYPE_HOTEL, null=False, default=1, verbose_name=_("نوع هتل"))
...
class Room(models.Model):
    ...
    default_cover = models.ForeignKey(Room_cover, on_delete=models.SET_NULL, blank=True, null=True,
    ...
    def __str__(self):
        return str(self.hotel.name + '----' + self.title )
...
class Discount(models.Model):
    ...
    hotel = models.ForeignKey(Hotel, on_delete=models.SET_NULL, blank=True, null=True, related_name="hotel_discount",
                              verbose_name=_("هتل"))
...
class Calender_pricing(models.Model):
    title = models.CharField(null=True, max_length=255, verbose_name=_("عنوان"))
    start_date = models.DateField(null=True, verbose_name=_('تاریخ آپدیت'))
    end_date = models.DateField(null=True, verbose_name=_('تاریخ آپدیت'))
    date_upd = models.DateTimeField(auto_now=True, verbose_name=_('تاریخ آپدیت'))
    date_add = models.DateTimeField(auto_now_add=True, null=True, verbose_name=_('تاریخ ایجاد'))
...
class Room_pricing(models.Model):
    TYPE_TRUE = ((1, 'Yes'), (0, 'NO'),)
    hotel = models.ForeignKey(Hotel, on_delete=models.SET_NULL, null=True, related_name="hotel_pricing", verbose_name=_("هتل"))
    ...
    base = models.DecimalField(null=True, max_digits=12, decimal_places=2, default=0, verbose_name=_("قیمت هتل"))
    price = models.DecimalField(null=True, max_digits=12, decimal_places=2, default=0, verbose_name=_("قیمت مشتری"))
